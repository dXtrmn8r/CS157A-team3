            ...
            if(null != ticket_type)switch (ticket_type) {
                ...
                case "Coach Class":
                    ...
                    if(no_of_seats > cs_valid){
                        ...
                        String update_cs = "UPDATE flights SET eco_class_seat_booked = eco_class_seat_booked + ?, eco_class_seat_aval = eco_class_seat_aval - ? WHERE flight_id = ? AND date_of_flight = ? ";
